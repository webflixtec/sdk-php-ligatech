...
class LigatechException extends Exception{
    ...
    public static function fromObjectMessage($message, $code, $previous = null){
        ...
        if(is_array($message)){
            ...
            return new LigatechException( new Exception(implode("\n", $newMessageString), $code, $previous) );     
        }
        
        if(is_string($message)){
            
            return new LigatechException( new Exception($message, $code, $previous) );     
    ...
    public static function fromGuzzleException(ServerException|ClientException|BadResponseException $ex){
        ...
        return new LigatechException( new Exception($responseBody, $ex->getCode(), $ex->getPrevious()) );
    }
